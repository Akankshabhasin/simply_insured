            ...
            <div className="bigContainer-transfer" style={{paddingTop: this.state.padd}}>
                <div className="container">
                        <div className="row margined">
                            <div className="col">
                                <input type="text" className="form-control" placeholder="Hash" onKeyPress={this.onKeyPress}/>
                            </div>
                            <Link to="/Dashboard">
                                <button className="linkTransform custom-btn-transfer btn btn-warning" onClick={this.props.logIn}>Submit</button>
                            </Link>
                        </div>
                </div>
            </div>
