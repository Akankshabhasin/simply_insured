                ...
                <div className="bigContainer-credit" style={{paddingTop: this.state.padd}}>
                    ...
                    <div className="container">
                        ...
                        <div className="margined progress">
                            <div className="progress-bar progress-bar-striped progress-bar-animated bg-warning" role="progressbar" style={{width: "15%"}} aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"/>
                        </div>

                        <p className="margined"> <span className="category-credit"> You used: </span>{"9"} out of {"60"} ETH </p>
